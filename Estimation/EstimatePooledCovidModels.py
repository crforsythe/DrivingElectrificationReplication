...
def loadData(type='car', subset='pooled'):
    file = r"Data\ChoiceData\Pooled\PooledCovidUnaffected.xlsx"
...
carSUVVarsPartworth = ['Acceleration', 'OpCost', 'bev100', 'bev150', 'bev300', 'bev400', 'phev20', 'phev40', 'hev', 'chinese', 'american', 'skorean', 'japanese', 'noBEVFC']
carSUVVarsLinear = ['Acceleration', 'OpCost', 'bev', 'bevRangeRel', 'phev20', 'phev40', 'hev', 'chinese', 'american', 'skorean', 'japanese', 'noBEVFC']
carSUVVarsAsinh = ['Acceleration', 'OpCost', 'bev', 'asinhBEVRange', 'phev20', 'phev40', 'hev', 'chinese', 'american', 'skorean', 'japanese', 'noBEVFC']
carSUVSpecs = {'linear':carSUVVarsLinear}

truckVarsLinear = ['payloadCapacity', 'towingCapacity', 'OpCost', 'bev', 'bevRangeRel', 'phev20', 'phev40', 'hev']
truckSpecs = {'linear':truckVarsLinear}

specs = {'car':carSUVSpecs, 'suv':carSUVSpecs}
weights = {'unweighted':None}
    ...
    for specName, specVars in spec.items():
        for modelType in ['simple', 'mixed']:
            for weightName, weightCol in weights.items():
                ...
                modelID = 'pooledCovid-{}-{}-{}-{}'.format(vehType, specName, modelType, weightName)
                if(modelType=='mixed'):
                ...
                with open('Models/pooledCovidModels.dat', 'wb') as file:
                    pickle.dump(r, file)
                    file.close()

                with open('Models/pooledCovidModels.dat', 'rb') as file:
